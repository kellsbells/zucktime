		...
		<div id="about" class="about">
			<div class="container">
				...
				<div class="imagetext">
					...
					<div class="text">
						<p>Hi! My name is Kellee. I'm so excited that you're here on my site! To think that I build things every day that affect people I've never even met has to be the coolest feeling in the world. Which I guess explains social medias like Instagram and Twitter. I love what I do though. I love solving problems and making a difference in the world of web. I'm still baffled at the amount of things there are to learn in this industry, but I'm enjoying the journey. I've been incredibly blessed to work with some of the most talented programmers and strive to contantly surround myself with them and valuable learning experiences. I love seeing myself progress as a developer and get bored when I'm not challenged. When I'm not coding you'll probably find me hiking and thinking about coding, or feeding a Netflix addiction and feeling guilty for not coding. I also have a load of cool cat t-shirts.</p>
					</div>
				</div>
